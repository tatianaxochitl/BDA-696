...
# plotly sections
# create a scatter plot tutorial: https://plotly.com/python/line-and-scatter/
fig = px.scatter(
    iris_df,
    x="sepal width in cm",
...
# create a violin plot using tutorial from: https://plotly.com/python/violin/
fig = go.Figure()
...
# using list from https://scikit-learn.org/stable/auto_examples/classification
...
for z in classifier_list:
    ...
    temp_pipe.fit(X, y)
    print("{:<65s}{:>4s}".format(str(z) + ": ", str(temp_pipe.score(X, y))))
